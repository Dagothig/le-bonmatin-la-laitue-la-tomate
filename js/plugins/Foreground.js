...
(function() {
  ...
  Game_Map.prototype.setupForeground = function() {
    if ($dataMap.meta) {
      ...
      this._foregroundBlendMode =  PIXI.BLEND_MODES[$dataMap.meta.fgBlendMode] || PIXI.BLEND_MODES.NORMAL;
      this._foregroundAlpha = Math.min(Math.max(Number($dataMap.meta.fgAlpha), 0), 1);
    }
    this._foregroundX = 0;
    this._foregroundY = 0;
  };
  ...
  Spriteset_Map.prototype.updateForeground = function() {
    ...
    if (this._foreground.bitmap) {
      ...
      this._foreground.blendMode = $gameMap._foregroundBlendMode;
      this._foreground.alpha = $gameMap._foregroundAlpha;
    }
  };
